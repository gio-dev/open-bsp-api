---
story_key: 10-1-correlacao-classificacao-culpa
epic: epic-10
...
# Story Correlacao e classificacao de culpa

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** Suporte N2 e telemetria.
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_epic10_story101_incident_correlation_atdd.py`
