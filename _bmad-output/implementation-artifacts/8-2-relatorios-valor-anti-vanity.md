---
story_key: 8-2-relatorios-valor-anti-vanity
epic: epic-8
...
# Story Relatorios de valor anti-vanity

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** Metricas ligadas a incidentes/volume quando existir.
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_epic8_story82_value_report_atdd.py`
