---
story_key: 9-1-finalidades-bases-legais-fluxo
epic: epic-9
...
# Story Finalidades e bases legais por fluxo

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** Governanca e ligacao ao editor de fluxos.
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_epic9_story91_legal_basis_atdd.py`
