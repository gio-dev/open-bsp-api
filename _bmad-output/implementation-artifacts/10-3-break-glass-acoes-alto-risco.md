---
story_key: 10-3-break-glass-acoes-alto-risco
epic: epic-10
...
# Story Break-glass e acoes de alto risco

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** Alto risco com governanca.

**Requisitos:** FR53, FR54, NFR-LGPD-03
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_epic10_story103_break_glass_atdd.py`
