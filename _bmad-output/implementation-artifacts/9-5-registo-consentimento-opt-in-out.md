---
story_key: 9-5-registo-consentimento-opt-in-out
epic: epic-9
...
# Story Registo consentimento opt-in/out

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** Consent log e epico 6.
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_epic9_story95_consent_log_atdd.py`
