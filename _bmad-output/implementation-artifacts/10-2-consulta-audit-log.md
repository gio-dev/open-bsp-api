---
story_key: 10-2-consulta-audit-log
epic: epic-10
...
# Story Consulta audit log

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** Auditoria tenant-scoped.
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_epic10_story102_audit_log_atdd.py`
