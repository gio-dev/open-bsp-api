---
story_key: f2-1-agente-inteligente-politicas
epic: epic-f2
...
# Story F2 Agente inteligente com politicas

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** LLM/ agente atras de flag; politicas de custo.

**Requisitos:** FR27 (gate F2)
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_f2_story_f21_agent_intelligence_atdd.py`
