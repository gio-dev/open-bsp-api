---
story_key: 8-3-entitlements-alertas
epic: epic-8
...
# Story Entitlements e alertas

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** Limites e alertas honestos.

**Requisitos:** FR43, FR25 cross
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_epic8_story83_entitlements_atdd.py`
