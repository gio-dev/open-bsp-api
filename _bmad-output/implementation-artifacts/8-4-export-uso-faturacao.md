---
story_key: 8-4-export-uso-faturacao
epic: epic-8
...
# Story Export de uso e faturacao

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** Export financeiro seguro.

**Requisitos:** FR44; NFR-LGPD-02
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_epic8_story84_usage_export_atdd.py`
