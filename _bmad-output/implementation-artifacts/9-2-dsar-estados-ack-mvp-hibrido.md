---
story_key: 9-2-dsar-estados-ack-mvp-hibrido
epic: epic-9
...
# Story DSAR estados e ACK MVP hibrido

## Story (resumo)

Contexto completo em `epics.md`. **Foco DS:** Pedidos DSAR e estados.
...
- [ ] pytest integracao; ATDD em `v2/apps/api/tests/atdd/test_epic9_story92_dsar_atdd.py`
